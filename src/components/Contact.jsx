        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              I'm currently seeking internship or entry-level junior developer roles.
              Open to remote, hybrid, or in-office opportunities. <br/>
              Feel free to reach out — I'd love to hear about your opportunities!
            </p>
            ...
            <AnimatePresence>
              {submitStatus && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className={`p-3 rounded-xl flex items-center gap-2 ${submitStatus.type === 'success'
